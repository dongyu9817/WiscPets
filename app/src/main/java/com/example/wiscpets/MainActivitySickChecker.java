...
//This activity is for registering pets in the Sickness Checker module
public class MainActivitySickChecker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sickness_checker);
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent(this, com.example.wiscpets.app.app_settings_activity.class);
    ...
    public void onBackPressed() {
        finish();
        Intent tIntent = new Intent(this, com.example.wiscpets.app.app_home.class);
